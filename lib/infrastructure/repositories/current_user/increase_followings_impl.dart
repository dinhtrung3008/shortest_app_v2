...
@LazySingleton(as: IIncreaseFollowings)
class IncrementFollowingsImpl with ExecuteRepositoryImpl, ConnectionChecker implements IIncreaseFollowings {
  final ICurrentUserRemoteService _iCurrentUserRemoteService;
  final IUserLocalService _iUserLocalService;

  IncrementFollowingsImpl(this._iCurrentUserRemoteService, this._iUserLocalService);
