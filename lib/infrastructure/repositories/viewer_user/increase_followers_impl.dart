...
@LazySingleton(as: IIncreaseFollowers)
class IncreaseFollowersImpl with ExecuteRepositoryImpl, ConnectionChecker implements IIncreaseFollowers {
  final IViewerUserRemoteService _iViewerUserRemoveService;

  IncreaseFollowersImpl(this._iViewerUserRemoveService);
  ...
  Future<Either<BaseFailure, UserShortest>> call({
    ...
    return executeRepositoryService<UserShortest>(
      action: () async {
        final response = await _iViewerUserRemoveService.incrementFollowers(
